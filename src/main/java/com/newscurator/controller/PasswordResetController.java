...
public class PasswordResetController {
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "202", description = "요청 처리됨 (이메일 발송 여부 미공개)"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "429", description = "시간당 발송 한도 초과 (등록 계정만)"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "503", description = "이메일 발송 실패")
    })
    @PostMapping("/request")
    public ResponseEntity<ApiResponse<Void>> requestCode(@RequestBody @Valid PasswordResetRequestDto request) {
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "검증 성공, resetToken 반환"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "코드 불일치 또는 계정 없음"),
    ...
    @ApiResponses({
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "resetToken 유효하지 않거나 이미 사용됨"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "422", description = "비밀번호 정책 위반")
    })
    @PostMapping("/confirm")
