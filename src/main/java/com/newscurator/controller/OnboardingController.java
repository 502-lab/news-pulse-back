...
public class OnboardingController {
    ...
    @ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "422", description = "관심 카테고리 3개 미만")
    })
    ...
    public ResponseEntity<ApiResponse<OnboardingStatusResponse>> getOnboardingStatus(
        ...
        return accountRepository.findById(userDetails.getAccountId())
                .map(account -> ResponseEntity.ok(ApiResponse.success(onboardingService.getStatus(account))))
